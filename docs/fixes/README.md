...
- [h171-arranque-marca.md](h171-arranque-marca.md) — misma H171, corrección del
  ...
  en `690344e`, workflow 34777097681 SUCCESS.
...
- [apertura-etiquetas-sin-bloqueo-h167.md](apertura-etiquetas-sin-bloqueo-h167.md) —
  ...
  Guardado real, A/B/C y hardware NO CERTIFICADO.
...
- [online-only-h164.md](online-only-h164.md) — H-164, IMPLEMENTADO Y PUBLICADO;
  ...
  reportados. SQL 218/219 corrige Punto Cero: un caso completo aislado y una
  verificación remota reversible PASS, configuración preservada; el agente no
  ejecutó una purga real. Otros dos equipos y un lote aislado siguen pendientes;
  no rediseña UI.
...
| `autoridad-mensajes-humanos-h134.md` | H-134 | Autoridad central de mensajes humanos y detalle técnico restringido |

-- H-124 · Regresión funcional autocontenida. No ejecuta ninguna limpieza y
-- revierte incluso sus filas técnicas de prueba.
begin;
...
begin
  ...
  raise notice 'H124_CLEANUP_PREVIEW_STABILITY_OK heartbeat=stable blocking=invalidates';
end;
$$;

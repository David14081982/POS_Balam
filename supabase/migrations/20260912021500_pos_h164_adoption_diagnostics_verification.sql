...
begin
 ...
 begin
  ...
  insert into pos.sync_devices(device_id,user_id,status,protocol_version,data_epoch,client_build,metadata) values
   (d,seller,'online',3,1,'2026-09-12-h164-online','{"preserved":true}'),
   (ad,admin,'online',3,1,'2026-09-12-h164-online','{"preserved":true}'),
   (rd,seller,'revoked',3,1,'2026-09-12-h164-online','{"preserved":true}');
  ...
  perform set_config('request.headers',jsonb_build_object('x-balam-device-id',d,'x-balam-client-build','2026-09-12-h164-online')::text,true);
  ...
  perform set_config('request.headers',jsonb_build_object('x-balam-device-id',ad,'x-balam-client-build','2026-09-12-h164-online')::text,true);
  ...
  perform set_config('request.headers',jsonb_build_object('x-balam-device-id',rd,'x-balam-client-build','2026-09-12-h164-online')::text,true);
